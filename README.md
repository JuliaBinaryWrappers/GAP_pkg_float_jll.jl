# `GAP_pkg_float_jll.jl` (v100.0.500+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/9125129329969c41dec3e727f930674012a6f9f7/G/GAP_pkg/GAP_pkg_float/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
