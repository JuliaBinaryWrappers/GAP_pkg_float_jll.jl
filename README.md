# `GAP_pkg_float_jll.jl` (v100.0.501+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/d3775303cbfd8018e0a89c9def8af9a81a46d67d/G/GAP_pkg/GAP_pkg_float/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
