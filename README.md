# `GAP_pkg_float_jll.jl` (v101.1000.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1b4ed24d77338ad8fa27b25a045659e8751a500a/G/GAP_pkg/GAP_pkg_float/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
