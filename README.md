# `GAP_pkg_float_jll.jl` (v100.0.500+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/202a5efa4a8a27795c9c57ec47acf182a44982a6/G/GAP_pkg/GAP_pkg_float/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
